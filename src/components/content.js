          ...
          <div className="columns">
            <div className="column is-three-quarters-desktop">
              ...
              <p className="subtitle is-size-4">
                ...
                I'm excited about static site generators and the rise of the headless CMS. By using React, Hugo and 
                GatsbyJS we can build the fastest websites in the world. I love clean code and high{" "}
                <a
